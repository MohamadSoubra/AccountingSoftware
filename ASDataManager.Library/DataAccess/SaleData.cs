...
namespace ASDataManager.Library.DataAccess
{
    public class SaleData
    {
        public void SaveSale(SaleModel saleInfo, string cashierId)
        {
            ...
            sql.SaveData<SaleDBModel>("dbo.spSale_Insert", sale, "ASDatabase");

            // Get the ID from the sale model
            sale.Id = sql.LoadData<int, dynamic>("spSale_Lookup", new {  sale.CashierId, sale.SaleDate }, "ASDatabase").FirstOrDefault();
            ...
            foreach (var item in details)
            {
                ...
                sql.SaveData("dbo.spSaleDetail_Insert", item, "ASDatabase");
            }
        }
